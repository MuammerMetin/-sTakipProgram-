...
<div class="container">
  <form action="personelbilgi.php" method="POST" enctype="multipart/form-data"  data-parsley-validate>
   <center>
     <div class="form-group col-md-6">
        <label>Bilgileri gösterilecek personelin mail adresi</label>
        <br>
        <br>
     ...
     <button type="submit" name="profilguncelle" class="btn btn-primary">Görüntüle</button> 
     </center>
   </form>
