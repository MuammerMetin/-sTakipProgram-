  ...
  <form action="islemler/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate>
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" required class="form-control" value="<?php echo $kullanicicek['kul_isim'] ?>" name="kul_isim" placeholder="İsim" disabled>
      </div>
      <div class="form-group col-md-6">
        <label>E-Posta</label>
        <input type="email" required class="form-control" value="<?php echo $kullanicicek['kul_mail'] ?>" name="kul_mail" placeholder="E-Mail" disabled>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label>Telefon Numarası</label>
        <input type="number" required class="form-control" value="<?php echo $kullanicicek['kul_telefon'] ?>" name="kul_telefon" placeholder="Telefon Numarası" disabled>
      </div>
      <div class="form-group col-md-6">
        <label>Ünvanı</label>
        <input type="text" required class="form-control" value="<?php echo $kullanicicek['kul_unvan'] ?>" name="kul_unvan" placeholder="Kullanıcı Ünvanı/Mesleği" disabled>
      </div>

        <div class="form-group col-md-6">
        <label>İzin günü</label>
        <input type="text" required class="form-control" value="<?php echo $kullanicicek['kul_izin1']; echo "&#160;&#160;";echo "/";echo "&#160;&#160;";  echo $kullanicicek['kul_izin2']; ?>" name="kul_unvan" placeholder="Kullanıcı Ünvanı/Mesleği" disabled>
      </div>
