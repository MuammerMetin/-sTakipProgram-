  ...
  <form action="islemler/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label>Görev alıcısı isim Soyisim</label>
        <input type="text" class="form-control" required name="musteri_isim" placeholder="Görevi alıcısı İsim Soyisim">
      </div>
      <div class="form-group col-md-6">
        <label>Görevi alacak olan kişinin E-Posta adresi</label>
        <input type="email" class="form-control" required name="musteri_mail" placeholder="Görev sahibi E-Mail">
      </div>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="number" class="form-control" required name="musteri_telefon" placeholder="Görev sahibi Telefon Numarası">
      </div>
      <div class="form-group col-md-6">
        <label>Görev başlığı</label>
        <input type="text" class="form-control" required name="sip_baslik" placeholder="Görev Başlığı">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
    ...
    <button type="submit" name="siparisekle" class="btn btn-primary">Görevi gönder & bidirimli</button>
  </form>
</div>
<!-- End of Main Content -->
