...
<head>
	...
	<link rel="shortcut icon" type="image/png"  style = "border-radius:100px;" href="<?php echo $ayarcek['site_logo'] ?>">
...
<?php 
							if (yetkikontrol()=="yetkili") {?>
	<li class="nav-item">
					<a class="nav-link" href="personelnot.php"">
						<i class="far fa-user"></i>
						<span>Personel sicil & not kaydı</span>
					</a>
				</li>
<?php } ?>
